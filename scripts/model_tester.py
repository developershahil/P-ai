"""Manual hard-case evaluator for the trained intent model."""
...
MODEL_PATH = BASE_DIR / "src" / "personal_ai" / "models" / "intent_model.pkl"
...
def run_hard_tests() -> None:
    """Run hard-coded intent checks against the model."""
    passed = 0
